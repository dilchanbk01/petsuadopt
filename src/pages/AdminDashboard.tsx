...
import { PlusCircle, Users, Heart, ArrowLeft, LogOut, Trash2, MessageCircle, CheckCircle, XCircle, Edit2 } from 'lucide-react';
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground">Adoption applications</p>
                </CardContent>
              </Card> 
            </div>
